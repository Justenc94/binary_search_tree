...
int main(int argc, char** argv) {
    ...
    Data tempData;
    int ids1[TREESIZE1] = {60, 20, 70, 40, 10, 50, 30};
    string strings1[TREESIZE1] = {"sixty", "twenty", "seventy", "forty", "ten", "fifty", "thirty"};
    int ids2[TREESIZE2] = {5, 15, 25, 35, 45, 55};
    string strings2[TREESIZE2] = {"five", "fifteen", "twenty five", "thirty five", "forty five", "fifty five"};
